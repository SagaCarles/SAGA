...
function UI.Load(TeleportModule, EventModule)
    ...
    -- Main Frame: Semi-Transparan agar estetik
    local MainFrame = Instance.new("Frame", ScreenGui)
    MainFrame.Size = UDim2.new(0, 240, 0, 330)
    MainFrame.Position = UDim2.new(0.5, -120, 0.3, 0)
    MainFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
    MainFrame.BackgroundTransparency = 0.2 -- Background tembus pandang dikit
    MainFrame.Active = true
    MainFrame.Draggable = true
    Instance.new("UICorner", MainFrame).CornerRadius = UDim.new(0, 12)
    
    -- Garis Tepi (Stroke) agar menu terlihat tegas
    local Stroke = Instance.new("UIStroke", MainFrame)
    Stroke.Color = Color3.fromRGB(0, 255, 200)
    Stroke.Thickness = 1.5

    -- Tombol S (Minimize Lingkaran)
    ...
    MiniBtn.TextColor3 = Color3.fromRGB(0, 0, 0) -- Teks Hitam di BG Hijau
    MiniBtn.BackgroundColor3 = Color3.fromRGB(0, 255, 200)
    local MiniRound = Instance.new("UICorner", MiniBtn)
    MiniRound.CornerRadius = UDim.new(1, 0) -- LINGKARAN POSISI TERBUKA
    ...
    TabEv.Font = Enum.Font.GothamBold -- BOLD
    TabEv.TextColor3 = Color3.fromRGB(255, 255, 255) -- PUTIH TERANG
    ...
    TabTp.Text = "TELEPORT"
    TabTp.Font = Enum.Font.GothamBold -- BOLD
    TabTp.TextColor3 = Color3.fromRGB(255, 255, 255) -- PUTIH TERANG
    ...
    StatusLabel.Font = Enum.Font.GothamBold -- BOLD
    ...
    TimeLabel.Font = Enum.Font.GothamBold -- BOLD
    TimeLabel.TextColor3 = Color3.fromRGB(0, 255, 200)
    TimeLabel.BackgroundTransparency = 1

    local ToggleBtn = Instance.new("TextButton", PageEv)
    ToggleBtn.Size = UDim2.new(1, 0, 0, 45); ToggleBtn.Position = UDim2.new(0, 0, 0, 80)
    ToggleBtn.Text = "START SMART AUTO"
    ToggleBtn.Font = Enum.Font.GothamBold -- BOLD
    ToggleBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
    ToggleBtn.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
    Instance.new("UICorner", ToggleBtn)

    -- Teleport List (Fixed Font Visibility)
    local function buildTp()
        ...
        for name, data in pairs(TeleportModule.ISLANDS) do
            ...
            btn.TextColor3 = Color3.fromRGB(255, 255, 255) -- PAKSA PUTIH AGAR KELIHATAN
            ...
            btn.MouseButton1Click:Connect(function()
                ...
                back.TextColor3 = Color3.new(1, 1, 1); back.BackgroundColor3 = Color3.fromRGB(100, 40, 40)
                Instance.new("UICorner", back).MouseButton1Click:Connect(buildTp)
                for _,s in pairs(data) do
                    local sb = Instance.new("TextButton", PageTp)
                    sb.Size = UDim2.new(0, 200, 0, 40); sb.Text = s[1]; sb.Font = Enum.Font.GothamBold
    ...
    -- Logika Lingkaran S saat Minimize
    ...
    MiniBtn.MouseButton1Click:Connect(function()
        ...
        FloatingS.Position = UDim2.new(0, MainFrame.AbsolutePosition.X, 0, MainFrame.AbsolutePosition.Y)
        FloatingS.BackgroundColor3 = Color3.fromRGB(0, 255, 200)
        FloatingS.Text = "S"
        FloatingS.Font = Enum.Font.GothamBold
        FloatingS.TextSize = 25
        FloatingS.TextColor3 = Color3.new(0, 0, 0)
        local c = Instance.new("UICorner", FloatingS)
        c.CornerRadius = UDim.new(1, 0) -- LINGKARAN SEMPURNA
    ...
    ToggleBtn.MouseButton1Click:Connect(function()
        ...
        ToggleBtn.BackgroundColor3 = EventModule._G_Enabled and Color3.fromRGB(0, 120, 255) or Color3.fromRGB(25, 25, 25)
    end)
